#!/usr/bin/env bash
# Export CycloneDX SBOM for chunk-your-skills and Snyk SBOM test report.
#
# Generated from Cargo.lock (do not edit by hand):
#   chunk-your-skills.cdx.json  — CycloneDX SBOM (cargo cyclonedx)
#   chunk-your-skills.snyk.json — Snyk SBOM test result
#
...
CDX_FILE="${REPO_ROOT}/chunk-your-skills.cdx.json"
SNYK_FILE="${REPO_ROOT}/chunk-your-skills.snyk.json"
DO_CHECK=0
...
Writes chunk-your-skills.cdx.json and chunk-your-skills.snyk.json.
...
export_rust_sbom() {
	...
	assert_no_absolute_paths "${cdx_tmp}" "chunk-your-skills.cdx.json"
	cp "${cdx_tmp}" "${cdx_out}"
	...
	(
		...
		run_cmd snyk sbom test \
			--file="chunk-your-skills.cdx.json" \
			--include-ignores \
	...
	assert_no_absolute_paths "${snyk_out}" "chunk-your-skills.snyk.json"
}
...
if [[ "${DO_CHECK}" -eq 1 ]]; then
	...
	export_rust_sbom "${tmp_dir}/chunk-your-skills.cdx.json" "${tmp_dir}/chunk-your-skills.snyk.json"

	status=0
	for name in chunk-your-skills.cdx.json chunk-your-skills.snyk.json; do
